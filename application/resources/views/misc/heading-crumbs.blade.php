...
<div class="col-md-12 {{ runtimeCrumbsColumnSize($page['crumbs_col_size'] ?? '') }} align-self-center {{ $page['crumbs_special_class'] ?? '' }} {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }}" id="breadcrumbs">
