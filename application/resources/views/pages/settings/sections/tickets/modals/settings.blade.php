...
<div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }}">
    <label class="col-12 col-form-label">@lang('lang.tickets_apply_when_customer_replied')</label>
...
<div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }}">
    <label class="col-12 col-form-label">@lang('lang.tickets_apply_when_staff_replied')</label>
    <div class="col-12 text-left p-t-5">
