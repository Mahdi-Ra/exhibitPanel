...
<div class="form-group row">
    <label
        class="col-12 {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }} control-label col-form-label required">{{ cleanLang(__('lang.category_name')) }}</label>
    <div class="col-12">
...
<div class="form-group row">
    <label class="col-12 {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }} control-label col-form-label required">@lang('lang.type')</label>
    <div class="col-12">
...
<div class="form-group row">
    <label class="col-12 {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }} control-label col-form-label">{{ cleanLang(__('lang.description')) }}</label>
    <div class="col-12">
...
<!--visibility-->
<div class="form-group row">
    <label class="col-12 col-form-label {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }}">{{ cleanLang(__('lang.visible_to')) }}</label>
    <div class="col-12">
...
<!--display-icon-->
<div class="form-group row">
    <label class="col-12 col-form-label {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }}">{{ cleanLang(__('lang.category_icon')) }}</label>
...
<div class="form-group row">
    <label
        class="col-12 {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }} control-label col-form-label required">{{ cleanLang(__('lang.move_artiles_to_another_category')) }}
