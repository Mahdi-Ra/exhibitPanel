...
<form class="form {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }}" id="settingsFormGeneral">
    ...
    <div class="form-group row">
        <label for="example-month-input"
            class="col-12 col-form-label ">{{ cleanLang(__('lang.timezone')) }}</label>
        <div class="col-12">
    ...
    <div class="form-group row">
        <label for="example-month-input"
            class="col-12 col-form-label ">{{ cleanLang(__('lang.date_format')) }}</label>
        <div class="col-12">
    ...
    <div class="form-group row">
        <label for="example-month-input"
            class="col-12 col-form-label ">{{ cleanLang(__('lang.date_picker_format')) }}</label>
        <div class="col-12">
    ...
    <div class="form-group row">
        <label for="example-month-input"
            class="col-12 col-form-label ">{{ cleanLang(__('lang.left_menu_position')) }}</label>
        <div class="col-12">
    ...
    <div class="form-group row">
        <label for="example-month-input"
            class="col-12 col-form-label ">{{ cleanLang(__('lang.stats_panel_default')) }}</label>
        <div class="col-12">
    ...
    <div class="form-group row">
        <label for="example-month-input"
            class="col-12 col-form-label ">{{ cleanLang(__('lang.close_modal_windows_on_page_click')) }}</label>
        <div class="col-12">
    ...
    <div class="form-group row">
        <label for="example-month-input"
            class="col-12 col-form-label ">{{ cleanLang(__('lang.session_timeout_popup')) }}</label>
        <div class="col-12">
    ...
    <div class="form-group row">
        <label for="example-month-input"
            class="col-12 col-form-label ">{{ cleanLang(__('lang.default_language')) }}</label>
        <div class="col-12">
    ...
    <div class="form-group row">
        <label for="example-month-input"
            class="col-12 col-form-label ">{{ cleanLang(__('lang.allow_users_to_change_language')) }}</label>
        <div class="col-12">
    ...
    <div class="form-group row">
        <label for="example-month-input" class="col-12 col-form-label ">@lang('lang.exporting_content') -
