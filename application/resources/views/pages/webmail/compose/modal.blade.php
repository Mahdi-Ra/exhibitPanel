...
<div class="form-group row">
    <label class="col-12 {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }} control-label col-form-label required">@lang('lang.to')</label>
...
<!--subject-->
<div class="form-group row">
    <label class="col-12 {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }} control-label col-form-label">@lang('lang.subject')</label>
    <div class="col-12">
...
<!--template-->
<div class="form-group row">
    <label class="col-12 {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }} control-label col-form-label">@lang('lang.use_a_template')</label>
    <div class="col-12">
...
<!--from email-->
<div class="form-group row">
    <label class="col-12 {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }} control-label col-form-label required">@lang('lang.from')</label>
    <div class="col-12">
...
<!--warning-->
<div class="alert alert-warning {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }}">@lang('lang.email_address_warning')</div>