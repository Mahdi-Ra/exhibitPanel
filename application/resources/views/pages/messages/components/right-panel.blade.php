<div class="chat-right-aside {{ app()->getLocale() == 'persian_br' ? 'rtl-chat-right' : 'ltr-chat-right' }}" id="messages_right_text_wrapper">

    <!--feed container-->
    <div class="chat-rbox {{ app()->getLocale() == 'persian_br' ? 'rtl-chat-rbox' : 'ltr-chat-rbox' }}" id="feed_container" data-autoload="no" data-url="" data-form-id="feed_container_data"
    ...
    <div class="card-post" id="messaging_submit_container">
        ...
        <button type="button" id="messaging_submit_button"
            class="btn btn-danger btn-icon-circle messaging_submit_button ajax-request {{ app()->getLocale() == 'persian_br' ? 'rtl_messaging_submit_button' : 'ltr_messaging_submit_button' }}"
        ...
        <button type="button" id="messaging_file_upload_button"
            class="btn btn-info btn-icon-circle messaging_file_upload_button {{ app()->getLocale() == 'persian_br' ? 'rtl_messaging_file_upload_button' : 'ltr_messaging_file_upload_button' }}">
