...
<tr id="template_{{ $template->contract_template_id }}">
    ...
    <!--title-->
    <td class="col_contract_template_title {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }}">
    ...
    <td class="col_contract_template_created {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }}">
        {{ runtimeDate($template->contract_template_created) }}
    </td>

    <!--created by-->
    <td class="col_created_by {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }}">
    ...
    <!--actions-->
    <td class="col_contracts_actions actions_column {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }}">
        <!--action button-->
