...
<tr id="template_{{ $template->proposal_template_id }}">
    ...
    <!--title-->
    <td class="col_proposal_template_title {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }}">
    ...
    <td class="col_proposal_template_created {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }}">
    ...
    <!--actions-->
    <td class="col_proposals_actions actions_column {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }}">
        <!--action button-->
