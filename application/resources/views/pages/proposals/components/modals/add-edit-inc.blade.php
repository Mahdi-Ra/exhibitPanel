...
<div class="modal-selector">
    ...
    <div class="customer-selector-container" id="customer-type-client-container">
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }} control-label col-form-label required">@lang('lang.client')</label>
    ...
    <div class="customer-selector-container hidden" id="customer-type-lead-container">
        <div class="form-group row">
            <label class="col-sm-12 col-lg-3 {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }} control-label col-form-label required">@lang('lang.lead')</label>
            <div class="col-sm-12 col-lg-9">
                <!--select2 basic search-->
...
<div class="form-group row">
    <label
        class="col-sm-12 col-lg-3 {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }} control-label col-form-label required">@lang('lang.proposal_title')</label>
    <div class="col-sm-12 col-lg-9">
...
<div class="form-group row">
    <label
        class="col-sm-12 col-lg-3 {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }} control-label col-form-label required">@lang('lang.proposal_date')</label>
    <div class="col-sm-12 col-lg-9">
...
<!--valid_until-->
<div class="form-group row">
    <label class="col-sm-12 col-lg-3 {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }} control-label col-form-label">@lang('lang.valid_until')</label>
    <div class="col-sm-12 col-lg-9">
...
<div class="form-group form-group-checkbox row">
    <label class="col-10 col-form-label {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }}">@lang('lang.automation') <span class="align-middle text-info font-16"
    ...
    <div class="col-2 {{ app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }} p-t-5">
