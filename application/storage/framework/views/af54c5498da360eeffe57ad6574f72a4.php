...
<tr id="template_<?php echo e($template->contract_template_id); ?>">
    ...
    <!--title-->
    <td class="col_contract_template_title <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
    ...
    <td class="col_contract_template_created <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
    ...
    <!--actions-->
    <td class="col_contracts_actions actions_column <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
        <!--action button-->
...
<!--each row--><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/templates/contracts/components/table/ajax.blade.php ENDPATH**/ ?>