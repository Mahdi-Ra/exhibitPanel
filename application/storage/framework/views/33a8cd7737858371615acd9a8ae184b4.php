...
<tr id="role_<?php echo e($role->role_id); ?>">
    <td class="roles_col_name <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
...
<!--each row--><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/roles/table/ajax.blade.php ENDPATH**/ ?>