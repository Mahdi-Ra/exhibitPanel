...
<form class="form <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>" id="settingsFormGeneral">
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label"><?php echo app('translator')->get('lang.reports'); ?> - <?php echo app('translator')->get('lang.truncate_long_text'); ?></label>
    ...
    <!--[reports] - truncate long title-->
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label"><?php echo app('translator')->get('lang.login_brute_force_protection'); ?>)</label>
        <div class="col-2 text-right p-t-5">
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/tweak/tweak.blade.php ENDPATH**/ ?>