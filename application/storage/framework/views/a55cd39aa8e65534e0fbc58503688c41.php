...
<!--settings-->
<form class="<?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
    <!--permission - view tasks-->
    <div class="form-group form-group-checkbox row">
        <label class="col-4 col-form-label"><?php echo e(cleanLang(__('lang.view_tasks'))); ?></label>
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-4 col-form-label required"><?php echo e(cleanLang(__('lang.task_participation'))); ?>**</label>
        <div class="col-8 p-t-5">
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-4 col-form-label required"><?php echo e(cleanLang(__('lang.create_tasks'))); ?>**</label>
        <div class="col-8 p-t-5">
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-4 col-form-label"><?php echo e(cleanLang(__('lang.view_time_sheets'))); ?></label>
        <div class="col-8 p-t-5">
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-4 col-form-label"><?php echo e(cleanLang(__('lang.view_expenses'))); ?></label>
        <div class="col-8 p-t-5">
    ...
    <div>
        <a href="https://growcrm.io/documentation" target="_blank" class="btn btn-sm btn-info help-documentation <?php echo e(app()->getLocale() == 'persian_br' ? 'float-right' : 'float-left'); ?>"><i
                class="ti-info-alt"></i>
    ...
    <div class="text-right">
        <button type="submit" id="commonModalSubmitButton"
            class="btn btn-rounded-x btn-danger waves-effect text-left js-ajax-ux-request <?php echo e(app()->getLocale() == 'persian_br' ? 'float-left' : 'float-right'); ?>"
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/projects/client-permissions.blade.php ENDPATH**/ ?>