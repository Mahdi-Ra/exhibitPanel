 ...
 <div class="form-group row">
     <label class="col-12 { app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }} control-label col-form-label required"><?php echo app('translator')->get('lang.response_title'); ?></label>
     <div class="col-12">
 ...
 <div class="form-group row">
     <label class="col-12 { app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }} control-label col-form-label required"><?php echo app('translator')->get('lang.category'); ?></label>
     <div class="col-12">
 ...
 <!--message-->
 <div class="form-group row">
     <label class="col-12 { app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }} control-label col-form-label required"><?php echo app('translator')->get('lang.message'); ?></label>
     <div class="col-12">
 ...
 <div class="form-group form-group-checkbox row">
     <div class="col-12 p-t-5 { app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }}">
 ...
 <?php endif; ?><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/canned/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>