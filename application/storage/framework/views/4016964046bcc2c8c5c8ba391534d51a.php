...
<div class="form-group row">
    <label
        class="col-12 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label required"><?php echo e(cleanLang(__('lang.category_name'))); ?></label>
    <div class="col-12">
...
<div class="form-group row">
    <label class="col-12 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label required"><?php echo app('translator')->get('lang.type'); ?></label>
    <div class="col-12">
...
<div class="form-group row">
    <label class="col-12 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label"><?php echo e(cleanLang(__('lang.description'))); ?></label>
    <div class="col-12">
        <textarea class="form-control form-control-sm tinymce-textarea" rows="5" name="kbcategory_description"
            id="kbcategory_description"><?php echo clean($category->kbcategory_description ?? '---'); ?></textarea>
    </div>
</div>

<!--visibility-->
<div class="form-group row">
    <label class="col-12 col-form-label <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><?php echo e(cleanLang(__('lang.visible_to'))); ?></label>
    <div class="col-12">
...
<!--display-icon-->
<div class="form-group row">
    <label class="col-12 col-form-label <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><?php echo e(cleanLang(__('lang.category_icon'))); ?></label>
...
<div class="form-group row">
    <label
        class="col-12 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label required"><?php echo e(cleanLang(__('lang.move_artiles_to_another_category'))); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/knowledgebase/modals/add-edit-inc.blade.php ENDPATH**/ ?>