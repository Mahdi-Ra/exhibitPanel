...
<tr id="template_<?php echo e($template->proposal_template_id); ?>">
    ...
    <!--title-->
    <td class="col_proposal_template_title <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
    ...
    <td class="col_proposal_template_created <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
        <?php echo e(runtimeDate($template->proposal_template_created)); ?>

    </td>

    <!--created by-->
    <td class="col_created_by <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
    ...
    <!--actions-->
    <td class="col_proposals_actions actions_column <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
        <!--action button-->
...
<!--each row--><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/templates/proposals/components/table/ajax.blade.php ENDPATH**/ ?>