<div class="row">
    <div class="col-lg-12">
        ...
        <div class="form-group row">
            <label class="col-12 text-right control-label col-form-label required"><?php echo e($page['form_label_category_name'] ?? ''); ?></label>
            <div class="col-12">
        ...
        <div class="form-group row">
            <label class="col-12 text-right control-label col-form-label required"><?php echo e($page['form_label_move_items'] ?? ''); ?> (<?php echo e(cleanLang(__('lang.optional'))); ?>)</label>
            <div class="col-12">
...
</div><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/categories/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>