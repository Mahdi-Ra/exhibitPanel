<div class="count-<?php echo e(@count($projects ?? [])); ?> <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>" id="projects-view-wrapper">
    <div class="card">
        <div class="card-body">
...
</div><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/projects/views/list/table/table.blade.php ENDPATH**/ ?>