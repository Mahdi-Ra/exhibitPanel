<div class="row <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
    <div class="col-lg-12">
        <!--title-->
        <div class="form-group row">
            <label
                class="col-12 control-label col-form-label required"><?php echo e(cleanLang(__('lang.milestone_name'))); ?></label>
            <div class="col-12">
...
</div><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/milestones/modals/add-edit-inc.blade.php ENDPATH**/ ?>