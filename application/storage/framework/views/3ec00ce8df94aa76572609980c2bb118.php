...
<form class="<?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-4 col-form-label"><?php echo e(cleanLang(__('lang.tasks_collaboration'))); ?></label>
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/projects/staff-permissions.blade.php ENDPATH**/ ?>