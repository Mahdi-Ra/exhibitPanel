...
<div class="form-group row <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
    <label class="col-sm-12 control-label col-form-label"><?php echo app('translator')->get('lang.home_page'); ?></label>
    <div class="col-sm-12">
...
</div><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/roles/modals/homepage.blade.php ENDPATH**/ ?>