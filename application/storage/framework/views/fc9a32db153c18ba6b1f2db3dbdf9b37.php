...
<body class="loggedin fix-header card-no-border fix-sidebar <?php echo e($page['page'] ?? ''); ?>">
    ...
    <div id="main-wrapper">
        ...
        <!--page wrapper-->
        <div class="page-wrapper <?php echo e(app()->getLocale() == 'persian_br' ? 'right-direction' : 'left-direction'); ?>" id="settings-wrapper" style="margin-left: 210px;">
        <style>
...
</html><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/wrapper-settings.blade.php ENDPATH**/ ?>