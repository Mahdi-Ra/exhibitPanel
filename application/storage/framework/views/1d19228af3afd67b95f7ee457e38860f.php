...
<!--settings-->
<form class="form <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>" id="settingsFormEmailGeneral">
    ...
    <div class="form-group row">
        <label for="example-month-input"
            class="col-12 col-form-label"><?php echo e(cleanLang(__('lang.email_delivery'))); ?></label>
        <div class="col-12">
    ...
    <div class="splash-text">
        <div class="alert alert-danger text-right"><?php echo e(cleanLang(__('lang.cronjob_and_emails'))); ?>. <a
    ...
    <div class="text-right">
        <!--send a test email-->
        <button type="button" class="btn btn-info edit-add-modal-button js-ajax-ux-request reset-target-modal-form <?php echo e(app()->getLocale() == 'persian_br' ? 'float-left' : 'float-right'); ?>"
        ...
        <!--save changes-->
        <button type="submit" id="email-general-settings-button" class="btn btn-rounded-x btn-danger waves-effect text-left <?php echo e(app()->getLocale() == 'persian_br' ? 'float-left' : 'float-right'); ?>"
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/email/general.blade.php ENDPATH**/ ?>