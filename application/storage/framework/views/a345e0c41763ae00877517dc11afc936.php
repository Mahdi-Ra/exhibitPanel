...
<tr class="customfields-table-settings hidden toggle-table-settings-row  toggle-table-settings-row-<?php echo e($field->customfields_id); ?> <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/customfields/settings/tickets.blade.php ENDPATH**/ ?>