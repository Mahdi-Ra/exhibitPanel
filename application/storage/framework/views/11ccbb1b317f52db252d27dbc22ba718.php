<div class="row">
    <div class="col-lg-12">
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label"><?php echo e(cleanLang(__('lang.position'))); ?></label>
            <div class="col-sm-12 col-lg-9">
        ...
        <!--timezone-->
        <div class="form-group row">
            <label class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label"><?php echo e(cleanLang(__('lang.timezone'))); ?></label>
            <div class="col-sm-12 col-lg-9">
...
</div><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/contacts/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>