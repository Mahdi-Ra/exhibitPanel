...
<div class="row" id="js-trigger-clients-modal-add-edit" data-payload="<?php echo e($page['section'] ?? ''); ?>">
    <div class="col-lg-12">
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label required"><?php echo e(cleanLang(__('lang.company_name'))); ?>*</label>
        ...
        <div class="form-group row">
            <label for="example-month-input"
                class="col-sm-12 col-lg-3 col-form-label text-right"><?php echo e(cleanLang(__('lang.status'))); ?></label>
            <div class="col-sm-12 col-lg-9">
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label required"><?php echo e(cleanLang(__('lang.email_address'))); ?>*</label>
            <div class="col-sm-12 col-lg-9">
        ...
        <div id="add_client_billing_address_section" class="hidden">
            ...
            <div class="form-group row">
                <label for="example-month-input"
                    class="col-sm-12 col-lg-3 col-form-label <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><?php echo e(cleanLang(__('lang.country'))); ?></label>
                <div class="col-sm-12 col-lg-9">
            ...
            <div class="form-group row">
                <label
                    class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label"><?php echo e(cleanLang(__('lang.vat_tax_number'))); ?></label>
                <div class="col-sm-12 col-lg-9">
        ...
        <div id="add_client_shipping_address_section" class="hidden">
            ...
            <div class="form-group form-group-checkbox row" id="expense_billable_option">
                <label
                    class="col-sm-12 col-lg-3 col-form-label <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><?php echo e(cleanLang(__('lang.same_as_billing'))); ?></label>
        ...
        <div id="client_app_modules_collaped" class="hidden">
            ...
            <div class="form-group row">
                <label
                    class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label"><?php echo app('translator')->get('lang.enabled_modules'); ?></label>
                <div class="col-sm-12 col-lg-9">
...
</div><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/clients/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>