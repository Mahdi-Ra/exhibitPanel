...
<div class="card" id="project_details" data-progress="<?php echo e($project->project_progress); ?>">
    ...
    <div class="card-body p-t-10 p-b-10 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>" id="project_progress_container">
        <!--project progress-->
    ...
    <div class="card-body p-t-0 p-b-0 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
        <!--[client details]-->
        <?php if(auth()->user()->is_team): ?>
        <div class="p-b-20">
...
<!-- Column --><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/project/components/misc/details.blade.php ENDPATH**/ ?>