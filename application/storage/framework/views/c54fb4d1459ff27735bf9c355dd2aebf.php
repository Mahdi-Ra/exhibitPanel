...
<form class="form">
    ...
    <div class="form-group row">
        <label for="example-month-input"
            class="col-12 col-form-label <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><?php echo e(cleanLang(__('lang.order_articles_by'))); ?></label>
        <div class="col-12">
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/knowledgebase/page.blade.php ENDPATH**/ ?>