...
<div class="col-md-12  col-lg-6 align-self-center <?php echo e(app()->getLocale() == 'persian_br' ? 'text-left' : 'text-right'); ?> parent-page-actions p-b-9"
    ...
    <div id="list-page-actions">
        ...
        <span class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="listTableAction">
                <!--edit-->
                <a class="dropdown-item edit-add-modal-button js-ajax-ux-request reset-target-modal-form <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"
                ...
                <!--update progress-->
                <a class="dropdown-item actions-modal-button js-ajax-ux-request reset-target-modal-form <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"
                ...
                <!--stop all timers-->
                <a href="javascript:void(0)" class="dropdown-item confirm-action-danger <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"
                ...
                <a href="javascript:void(0)" class="dropdown-item confirm-action-info <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"
                ...
                <a class="dropdown-item js-ajax-ux-request edit-add-modal-button js-ajax-ux-request reset-target-modal-form <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"
                    href="javascript:void(0)" data-toggle="modal" data-target="#commonModal"
                ...
                <a href="javascript:void(0)"
                    class="dropdown-item edit-add-modal-button js-ajax-ux-request reset-target-modal-form <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"
                    data-toggle="modal" data-target="#commonModal"
...
<!-- action buttons --><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/project/components/misc/actions.blade.php ENDPATH**/ ?>