<div class="row">
    <div class="col-lg-12">
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label required"><?php echo e(cleanLang(__('lang.estimate_date'))); ?>*</label>
            <div class="col-sm-12 col-lg-9">
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label"><?php echo e(cleanLang(__('lang.expiry_date'))); ?></label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm pickadate" autocomplete="off"
        ...
        <div class="hidden" id="edit_bill_options_toggle">
            ...
            <!--terms-->
            <div class="form-group row">
                <label class="col-12 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label"><?php echo e(cleanLang(__('lang.terms'))); ?></label>
                <div class="col-12">
...
</div><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/estimates/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>