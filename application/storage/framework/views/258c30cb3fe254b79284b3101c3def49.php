...
<tr id="team_<?php echo e($team->id); ?>">
    <td class="team_col_first_name <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
    ...
    <td class="team_col_position <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
        <?php echo e(str_limit(runtimeCheckBlank($team->position), 20)); ?>

    </td>
    <?php if(config('visibility.action_super_user')): ?>
    <td class="team_col_role <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><?php echo e(runtimeCheckBlank($team->role['role_name'])); ?></td>
    <?php endif; ?>
    <td class="team_col_email <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
        <?php echo e(runtimeCheckBlank($team->email)); ?>

    </td>
    <td class="team_col_phone <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
        <?php echo e(runtimeCheckBlank($team->phone)); ?>

    </td>
    <?php if(config('visibility.action_super_user')): ?>
    <td class="team_col_last_active <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
        <?php echo e($team->carbon_last_seen); ?>

    </td>
    <?php endif; ?>
    <?php if(config('visibility.action_super_user')): ?>
    <td class="team_col_action <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
        <!--action buttons-->
...
<!--each row--><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/team/components/table/ajax.blade.php ENDPATH**/ ?>