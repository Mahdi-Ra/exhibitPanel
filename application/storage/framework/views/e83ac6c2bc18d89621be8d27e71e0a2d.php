...
<form class="form">
    ...
    <div class="text-right">
        <button type="submit" id="commonModalSubmitButton"
            class="btn btn-rounded-x btn-danger waves-effect text-left js-ajax-ux-request <?php echo e(app()->getLocale() == 'persian_br' ? 'float-left' : 'float-right'); ?>" data-url="/settings/tags"
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/tags/general.blade.php ENDPATH**/ ?>