<div class="chat-left-aside <?php echo e(app()->getLocale() == 'persian_br' ? 'float-right' : 'float-left'); ?> menu-closed">
    ...
    <div class="chat-left-inner" id="chat-left-inner">
        <ul class="chatonline style-none" id="messages-left-menu">
            ...
            <li id="<?php echo e(messagesUniqueID(auth()->user()->unique_id, 'team')); ?>">
                <a href="javascript:void(0)" class="ajax-request messages-menu-link active <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>" data-type="form"
                    ...
                    <img src="<?php echo e(url('public/images/team.png')); ?>" alt="user-img" class="img-circle <?php echo e(app()->getLocale() == 'persian_br' ? 'rtl-chatonline-img' : 'ltr-chatonline-img'); ?>">
