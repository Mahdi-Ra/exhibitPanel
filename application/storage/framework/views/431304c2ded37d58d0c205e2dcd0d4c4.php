<div class="table-responsive" id="milestone-categories-table">
    ...
    <table id="milestone-stages" class="table m-t-0 m-b-0 table-hover no-wrap contact-list <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>" data-page-size="10"
...
</div><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/milestones/table/table.blade.php ENDPATH**/ ?>