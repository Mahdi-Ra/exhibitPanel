<div class="table-responsive p-b-30">
    ...
    <table id="task-stages" class="table m-t-0 m-b-0 table-hover no-wrap contact-list <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>" data-page-size="10"
    ...
    <!--nothing found-->
    <?php endif; ?>
</div><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/tasks/table/table.blade.php ENDPATH**/ ?>