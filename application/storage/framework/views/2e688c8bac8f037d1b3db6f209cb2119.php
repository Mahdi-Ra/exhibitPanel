...
<form class="form">
    ...
    <div class="form-group row <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
        <label class="col-sm-12  control-label col-form-label"><?php echo app('translator')->get('lang.replying_tickets'); ?></label>
        <div class="col-sm-12">
    ...
    <div class="text-right">
        <button type="submit" id="commonModalSubmitButton"
            class="btn btn-rounded-x btn-danger waves-effect text-left js-ajax-ux-request <?php echo e(app()->getLocale() == 'persian_br' ? 'float-left' : 'float-right'); ?>" data-url="/settings/tickets"
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/tickets/page.blade.php ENDPATH**/ ?>