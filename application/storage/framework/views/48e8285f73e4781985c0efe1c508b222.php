<div class="row" id="js-projects-modal-add-edit" data-section="<?php echo e($page['section']); ?>"
    ...
    <div class="col-lg-12">
        ...
        <div class="client-selector">
            ...
            <div class="client-selector-container" id="client-existing-container">
                <div class="form-group row">
                    <label
                        class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label required"><?php echo e(cleanLang(__('lang.client'))); ?>*</label>
            ...
            <div class="client-selector-container hidden" id="client-new-container">
                <div class="form-group row">
                    <label
                        class="col-sm-12 col-lg-4 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label required"><?php echo e(cleanLang(__('lang.company_name'))); ?>*</label>
                ...
                <div class="form-group row">
                    <label
                        class="col-sm-12 col-lg-4 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label required"><?php echo e(cleanLang(__('lang.first_name'))); ?>*</label>
                    <div class="col-sm-12 col-lg-8">
                ...
                <div class="form-group row">
                    <label
                        class="col-sm-12 col-lg-4 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label required"><?php echo e(cleanLang(__('lang.last_name'))); ?>*</label>
                    <div class="col-sm-12 col-lg-8">
                ...
                <div class="form-group row">
                    <label
                        class="col-sm-12 col-lg-4 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label required"><?php echo e(cleanLang(__('lang.email_address'))); ?>*</label>
                    <div class="col-sm-12 col-lg-8">
            ...
            <div class="hidden" id="new-client-custom-fields">
                ...
                <div class="spacer row">
                    <div class="col-sm-12 col-lg-8 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
        ...
        <div class="client-selectors">
            <div class="form-group row">
                <label class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label"><?php echo app('translator')->get('lang.template'); ?></label>
                <div class="col-sm-12 col-lg-9">
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label required"><?php echo e(cleanLang(__('lang.project_title'))); ?>*</label>
            <div class="col-sm-12 col-lg-9">
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label required"><?php echo e(cleanLang(__('lang.start_date'))); ?>*</label>
            <div class="col-sm-12 col-lg-9">
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label"><?php echo e(cleanLang(__('lang.deadline'))); ?></label>
            <div class="col-sm-12 col-lg-9">
        ...
        <!--DESCRIPTION & DETAILS-->
        <div class="spacer row">
            <div class="col-sm-8 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
        ...
        <div class="hidden" id="edit_category_and_users">
            <div class="form-group row m-t-30">
                <label for="example-month-input"
                    class="col-sm-12 col-lg-3 col-form-label <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> required"><?php echo e(cleanLang(__('lang.category'))); ?></label>
                <div class="col-sm-12 col-lg-9">
            ...
            <div class="form-group row">
                <label
                    class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label"><?php echo e(cleanLang(__('lang.assigned'))); ?></label>
                <div class="col-sm-12 col-lg-9">
            ...
            <div class="form-group row">
                <label
                    class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label"><?php echo e(cleanLang(__('lang.manager'))); ?>
        ...
        <div class="hidden" id="edit_project_progress">
            ...
            <div class="form-group form-group-checkbox row">
                <label class="col-4 col-form-label <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><?php echo e(cleanLang(__('lang.set_progress_manually'))); ?>?</label>
        ...
        <div class="hidden" id="edit_project_setings">
            ...
            <div class="hidden" id="edit_project_billing">
                <div class="highlighted-panel">
                    ...
                    <div class="form-group row">
                        <label for="example-month-input"
                            class="col-sm-12 col-lg-4 col-form-label <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><?php echo e(cleanLang(__('lang.billing'))); ?></label>
                        <div class="col-sm-12 col-lg-4">
            ...
            <div class="spacer row">
                ...
                <div class="col-sm-4">
                    <div class="switch  <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
                        <label>
            ...
            <div id="edit_project_permissions_tasks" class="hidden highlighted-panel">
                ...
                <div class="form-group form-group-checkbox row">
                    <label class="col-5 col-form-label <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><?php echo e(cleanLang(__('lang.view_tasks'))); ?></label>
                    <div class="col-7 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> p-t-5">
                ...
                <div class="form-group form-group-checkbox row">
                    <label
                        class="col-5 col-form-label <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> required"><?php echo e(cleanLang(__('lang.task_participation'))); ?>**</label>
                    <div class="col-7 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> p-t-5">
                ...
                <div class="form-group form-group-checkbox row">
                    <label
                        class="col-5 col-form-label <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> required"><?php echo e(cleanLang(__('lang.create_tasks'))); ?>**</label>
                    <div class="col-7 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> p-t-5">
                ...
                <div class="form-group form-group-checkbox row">
                    <label class="col-5 col-form-label <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><?php echo e(cleanLang(__('lang.view_time_sheets'))); ?></label>
                    <div class="col-7 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> p-t-5">
                ...
                <div class="form-group form-group-checkbox row">
                    <label class="col-5 col-form-label <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><?php echo e(cleanLang(__('lang.view_expenses'))); ?></label>
                    <div class="col-7 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> p-t-5">
                ...
                <div><small class="text-bold <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">** <?php echo e(cleanLang(__('lang.if_items_selected_then_viewing_perm'))); ?></small>
                </div>
                <div class="line m-t-30"></div>
            </div>
            <!--/#CLIENT PERMISSIONS-->
        ...
        <div class="form-group form-group-checkbox row">
            <div class="col-12 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> p-t-5">
        ...
        <?php endif; ?>
    </div><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/projects/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>