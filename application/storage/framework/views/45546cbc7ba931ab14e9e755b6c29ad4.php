<div class="table-responsive">
    ...
    <table id="demo-foo-addrow" class="table m-t-0 m-b-0 table-hover no-wrap contact-list <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>" data-page-size="10">
        <thead>
            <tr>
...
</div><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/roles/table/table.blade.php ENDPATH**/ ?>