        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ticket-panel">
                    <div class="x-top-header <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
                    ...
                    <div class="x-body form-horizontal">
                        ...
                        <div class="form-group row">
                            <label for="example-month-input" class="col-12 control-label col-form-label <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> required"><?php echo e(cleanLang(__('lang.client'))); ?></label>
                            <div class="col-12">
                        ...
                        <!--project-->
                        <div class="form-group row">
                            <label for="example-month-input" class="col-12 col-form-label <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><?php echo e(cleanLang(__('lang.project'))); ?></label>
                            <div class="col-12">
                        ...
                        <!--department-->
                        <div class="form-group row">
                            <label for="example-month-input" class="col-12 control-label col-form-label <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> required"><?php echo e(cleanLang(__('lang.department'))); ?></label>
                            <div class="col-12">
                        ...
                        <div class="form-group row">
                            <label for="example-month-input" class="col-12 col-form-label { app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }}"><?php echo e(cleanLang(__('lang.project'))); ?></label>
                            <div class="col-12">
                        ...
                        <?php if(auth()->user()->is_team): ?>
                        <div class="form-group row">
                            <label for="example-month-input" class="col-12 col-form-label { app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left' }}"><?php echo e(cleanLang(__('lang.priority'))); ?></label>
                            <div class="col-12">
...
</div><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/tickets/components/create/options.blade.php ENDPATH**/ ?>