<div class="row">
    <div class="col-lg-12 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
        <!--title-->
        <div class="form-group row">
            <label
                class="col-12 control-label col-form-label required"><?php echo e(cleanLang(__('lang.role_name'))); ?></label>
            <div class="col-12">
...
</div><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/roles/modals/add-edit-inc.blade.php ENDPATH**/ ?>