...
<form class="form" id="settingsFormSubscriptions">
    ...
    <div class="form-group row">
        <label class="col-12 control-label col-form-label <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><?php echo e(cleanLang(__('lang.subscription_prefix'))); ?></label>
        <div class="col-12">
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/subscriptions/page.blade.php ENDPATH**/ ?>