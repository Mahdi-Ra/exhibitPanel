<div class="table-responsive" id="file-folders-table">
    ...
    <table id="demo-folder-addrow" class="table m-t-0 m-b-0 table-hover no-wrap contact-list <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>" data-page-size="10">
        <thead>
            <tr>
    ...
    <!--nothing found-->
    <?php endif; ?>
</div><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/files/table/table.blade.php ENDPATH**/ ?>