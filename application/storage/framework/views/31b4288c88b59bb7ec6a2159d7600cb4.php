                    ...
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group form-group-checkbox row">
                            <div class="col-12 p-t-5 text-right">
                                ...
                                <label class="p-r-30" for="standard_field[project_id]"><?php echo app('translator')->get('lang.id'); ?></label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row">
                            <div class="col-12 p-t-5 text-right">
                                <input type="checkbox" id="standard_field[project_title]"
                                    ...
                                    checked="checked">
                                <label class="p-r-30" for="standard_field[project_title]"><?php echo app('translator')->get('lang.title'); ?></label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row">
                            <div class="col-12 p-t-5 text-right">
                                <input type="checkbox" id="standard_field[project_status]"
                                    ...
                                    checked="checked">
                                <label class="p-r-30" for="standard_field[project_status]"><?php echo app('translator')->get('lang.status'); ?></label>
                            </div>
                        </div>
                    </div>
...
<!--sidebar--><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/export/projects/export.blade.php ENDPATH**/ ?>