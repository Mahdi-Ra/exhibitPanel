...
<div class="form-group row">
    <label class="col-12 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label required"><?php echo app('translator')->get('lang.to'); ?></label>
...
<!--subject-->
<div class="form-group row">
    <label class="col-12 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label"><?php echo app('translator')->get('lang.subject'); ?></label>
    <div class="col-12">
...
<!--template-->
<div class="form-group row">
    <label class="col-12 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label"><?php echo app('translator')->get('lang.use_a_template'); ?></label>
    <div class="col-12">
...
<!--from email-->
<div class="form-group row">
    <label class="col-12 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label required"><?php echo app('translator')->get('lang.from'); ?></label>
    <div class="col-12">
...
<!--warning-->
<div class="alert alert-warning <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><?php echo app('translator')->get('lang.email_address_warning'); ?></div><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/webmail/compose/modal.blade.php ENDPATH**/ ?>