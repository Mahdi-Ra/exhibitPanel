...
<form class="form" id="settingsFormFolders">
    ...
    <div class="form-group row">
        <label class="col-sm-12 text-left control-label col-form-label <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><?php echo app('translator')->get('lang.file_folders'); ?></label>
        <div class="col-sm-12">
    ...
    <div class="card-contrast-panel  <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> <?php echo e(runtimeVisibility('settings-file-folders-manage', $settings->settings2_file_folders_status)); ?>"
        ...
        <div class="form-group form-group-checkbox row">
            <label class="col-sm-12 col-lg-4 col-form-label <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><?php echo app('translator')->get('lang.assigned_users'); ?></label>
            <div class="col-sm-12 col-lg-8 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> p-t-5">
        ...
        <div class="form-group form-group-checkbox row">
            <label class="col-sm-12 col-lg-4 col-form-label <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><?php echo app('translator')->get('lang.project_manager'); ?></label>
            <div class="col-sm-12 col-lg-8 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> p-t-5">
        ...
        <div class="form-group form-group-checkbox row">
            <label class="col-sm-12 col-lg-4 col-form-label <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><?php echo app('translator')->get('lang.client'); ?></label>
            <div class="col-sm-12 col-lg-8 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> p-t-5">
    ...
    <div class="text-right">
        <button type="submit" id="commonModalSubmitButton"
            class="btn btn-rounded-x btn-danger waves-effect text-left ajax-request <?php echo e(app()->getLocale() == 'persian_br' ? 'flaot-left' : 'float-right'); ?>" data-url="/settings/files/folders"
...
<a href="https://growcrm.io/documentation" target="_blank" class="btn btn-sm btn-info help-documentation <?php echo e(app()->getLocale() == 'persian_br' ? 'float-left' : 'float-right'); ?>"><i
        class="ti-info-alt"></i>
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/files/folders.blade.php ENDPATH**/ ?>