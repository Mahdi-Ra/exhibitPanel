...
<form>
    <div class="table-responsive p-b-30 customfields-table">
        <table id="custom-fields" class="table m-t-0 m-b-0 table-hover no-wrap contact-list" data-page-size="10"">
            <thead>
            <th class="text-right"><?php echo e(cleanLang(__('lang.form_field_name'))); ?></th>
            <th class=" w-px-80 actions_column text-right"><?php echo e(cleanLang(__('lang.settings'))); ?></th>
            </tr>
            </thead>
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/customfields/table.blade.php ENDPATH**/ ?>