    ...
    <div class="col-lg-12">
        ...
        <ul data-modular-id="reports_tabs_menu" class="nav nav-tabs profile-tab reports-top-nav list-pages-crumbs"
            ...
            <li class="nav-item dropdown <?php echo e($page['reports_tabs_productivty'] ?? ''); ?>">
                ...
                <div class="dropdown-menu <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>" x-placement="bottom-start" id="fx-topnav-dropdown">
                    <!--[overview]-->
...
</div><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/reports/components/misc/topnav.blade.php ENDPATH**/ ?>