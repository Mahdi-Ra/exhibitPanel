<div class="row">
    <div class="col-lg-12">
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label required"><?php echo e(cleanLang(__('lang.rate'))); ?>*</label>
        ...
        <div id="items_dimensions_container" class="<?php echo e(runtimeVisibilityItemsType($item->item_type ?? '')); ?>">
            ...
            <div class="form-group row">
                <label class="col-sm-12 col-lg-3 text-right control-label col-form-label required">Length</label>
                <div class="col-sm-12 col-lg-9">
            ...
            <div class="form-group row">
                <label class="col-sm-12 col-lg-3 text-right control-label col-form-label required">Width</label>
                <div class="col-sm-12 col-lg-9">
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label  required"><?php echo e(cleanLang(__('lang.units'))); ?>*
...
</div><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/items/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>