...
<!--settings-->
<form class="form <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>" id="settingsFormEmailSMTP">
    ...
    <div class="form-group row">
        <label for="example-month-input"
            class="col-12 col-form-label"><?php echo e(cleanLang(__('lang.encryption'))); ?></label>
        <div class="col-12">
    ...
    <div class="col-12">
        <div class="alert alert-info m-t-40 p-t-30 p-b-30">
            <div class="email-testing-tool-sections" id="email-testing-tool-start">
                <h5 class="text-info text-right"><i class="sl-icon-info"></i> <?php echo app('translator')->get('lang.email_delivery_problem'); ?></h5>
                <p class="card-text text-right"><?php echo app('translator')->get('lang.use_tool_to_debug_smtp'); ?></p>
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/email/smtp.blade.php ENDPATH**/ ?>