<div class="row">
    <div class="col-lg-12">
        ...
        <!--copy items-->
        <h5 class="p-b-10 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><?php echo app('translator')->get('lang.copy_these_items'); ?></h5>
        <!--milestones-->
        <div class="form-group form-group-checkbox row">
            <div class="col-12 p-t-5 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
...
</div><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/projects/components/modals/clone.blade.php ENDPATH**/ ?>