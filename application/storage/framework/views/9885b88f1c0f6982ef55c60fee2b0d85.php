...
<!--settings-->
<form class="form <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
    ...
    <div class="form-group row">
        <label
            class="col-sm-12 col-lg-4 control-label col-form-label"><?php echo app('translator')->get('lang.manage_task_dependencies'); ?></label>
    ...
    <div class="text-right">
        <button type="submit" id="commonModalSubmitButton"
            class="btn btn-rounded-x btn-danger waves-effect text-left js-ajax-ux-request <?php echo e(app()->getLocale() == 'persian_br' ? 'float-left' : 'float-right'); ?>" data-url="/settings/tasks"
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/tasks/page.blade.php ENDPATH**/ ?>