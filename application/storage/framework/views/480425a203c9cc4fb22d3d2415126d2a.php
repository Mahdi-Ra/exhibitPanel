    ...
    <div id="list-page-actions">
        ...
        <span class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="listTableAction">
                <!--list view-->
                <a class="dropdown-item display-block ajax-request <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>" href="javascript:void(0)"
...
</div><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/projects/components/misc/list-page-actions.blade.php ENDPATH**/ ?>