...
<!--settings-->
<form class="form <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>" id="settingsFormCurrency">
    ...
    <div class="form-group row">
        <label for="example-month-input"
            class="col-12 col-form-label"><?php echo e(cleanLang(__('lang.currency_symbol_position'))); ?></label>
        <div class="col-12">
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/currency/page.blade.php ENDPATH**/ ?>