...
<div class="form-group row hidden">
    <label class="col-sm-12 col-lg-3 text-right control-label col-form-label"><?php echo e(cleanLang(__('lang.manager'))); ?>
...
<div class="form-group row hidden">
    <label
        class="col-sm-12 col-lg-3 text-right control-label col-form-label"><?php echo e(cleanLang(__('lang.assigned'))); ?></label>
    <div class="col-sm-12 col-lg-9">
...
<div id="edit_project_permissions_tasks" class="hidden highlighted-panel">
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-5 col-form-label <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> required"><?php echo e(cleanLang(__('lang.task_participation'))); ?>**</label>
        <div class="col-7 text-left p-t-5">
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-5 col-form-label <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> required"><?php echo e(cleanLang(__('lang.create_tasks'))); ?>**</label>
        <div class="col-7 text-left p-t-5">
...
<?php endif; ?>
<!--/#[billing details]--><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/templates/projects/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>