...
<form class="form <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>">
    ...
    <div>
        <a href="https://growcrm.io/documentation/leads-settings/" target="_blank"
            class="btn btn-sm btn-info help-documentation <?php echo e(app()->getLocale() == 'persian_br' ? 'float-right' : 'float-left'); ?>"><i class="ti-info-alt"></i>
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/leads/page.blade.php ENDPATH**/ ?>