    ...
    <div class="card-body">
        <div class="table-responsive list-table-wrapper">
            ...
            <table id="team-list-table" class="table m-t-0 m-b-0 table-hover no-wrap contact-list" data-page-size="10">
                <thead>
                    <tr>
                        <th class="team_col_first_name <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><a class="js-ajax-ux-request js-list-sorting"
                        ...
                        <th class="team_col_position <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><a class="js-ajax-ux-request js-list-sorting" id="sort_position"
                        ...
                        <th class="team_col_role <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><a class="js-ajax-ux-request js-list-sorting" id="sort_role_id"
                                href="javascript:void(0)"
                                data-url="<?php echo e(urlResource('/team?action=sort&orderby=role_id&sortorder=asc')); ?>"><?php echo e(cleanLang(__('lang.role'))); ?><span
                                    class="sorting-icons"><i class="ti-arrows-vertical"></i></span>
                        </th>
                        <?php endif; ?>
                        <th class="team_col_email <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><a class="js-ajax-ux-request js-list-sorting" id="sort_email"
                                href="javascript:void(0)"
                                data-url="<?php echo e(urlResource('/team?action=sort&orderby=email&sortorder=asc')); ?>"><?php echo e(cleanLang(__('lang.email'))); ?><span
                                    class="sorting-icons"><i class="ti-arrows-vertical"></i></span>
                        </th>
                        <th class="team_col_phone <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><a class="js-ajax-ux-request js-list-sorting" id="sort_phone"
                                href="javascript:void(0)"
                                data-url="<?php echo e(urlResource('/team?action=sort&orderby=phone&sortorder=asc')); ?>"><?php echo e(cleanLang(__('lang.phone'))); ?><span
                                    class="sorting-icons"><i class="ti-arrows-vertical"></i></span>
                        </th>
                        <?php if(config('visibility.action_super_user')): ?>
                        <th class="team_col_last_active <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><a class="js-ajax-ux-request js-list-sorting"
                        ...
                        <?php endif; ?>
                        <?php if(config('visibility.action_super_user')): ?>
                        <th class="team_col_action <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>"><a href="javascript:void(0)"><?php echo e(cleanLang(__('lang.action'))); ?></a>
                        </th>
                        <?php endif; ?>
                    </tr>
                </thead>
...
</div><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/team/components/table/table.blade.php ENDPATH**/ ?>