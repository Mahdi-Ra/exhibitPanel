    ...
    <div class="col-lg-12">
        ...
        <div class="client-selector">
            ...
            <div class="client-selector-container" id="client-existing-container">
                ...
                <div class="form-group row">
                    <label
                        class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label"><?php echo e(cleanLang(__('lang.project'))); ?></label>
                    <div class="col-sm-12 col-lg-9">
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label required"><?php echo e(cleanLang(__('lang.invoice_date'))); ?>*</label>
            <div class="col-sm-12 col-lg-9">
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label required"><?php echo e(cleanLang(__('lang.due_date'))); ?>*</label>
            <div class="col-sm-12 col-lg-9">
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label  required"><?php echo e(cleanLang(__('lang.project'))); ?>*</label>
            <div class="col-sm-12 col-lg-9">
        ...
        <div class="hidden" id="edit_bill_recurring_toggle">
            <!--tags-->
            <div class="form-group row">
                <label class="col-12 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label"><?php echo e(cleanLang(__('lang.tags'))); ?></label>
                <div class="col-12">
            ...
            <!-- notes-->
            <div class="form-group row">
                <label class="col-12 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label"><?php echo e(cleanLang(__('lang.notes'))); ?></label>
                <div class="col-12">
            ...
            <div class="form-group row">
                <label
                    class="col-12 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label"><?php echo e(cleanLang(__('lang.terms_and_conditions'))); ?></label>
                <div class="col-12">
        ...
        <!--recurring notes-->
        <div class="alert alert-info m-t-10 text-right"><i class="sl-icon-refresh text-warning"></i>
            <?php echo e(cleanLang(__('lang.recurring_invoice_options_info'))); ?></div>
    </div>
</div><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/invoices/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>