...
<!--settings-->
<form class="form <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?>" id="settings-proposals-automation">


    <!--settings2_proposals_automation_default_status-->
    <div class="form-group row p-b-10">
        <label class="col-sm-12 control-label col-form-label"><?php echo app('translator')->get('lang.proposal_automation_default'); ?> <span
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/settings/sections/proposals/automation.blade.php ENDPATH**/ ?>