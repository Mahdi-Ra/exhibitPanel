...
<div class="form-group row">
    <label
        class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label required"><?php echo app('translator')->get('lang.contract_title'); ?></label>
    <div class="col-sm-12 col-lg-9">
...
<!--contract_start_date-->
<div class="form-group row">
    <label class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label required"><?php echo app('translator')->get('lang.start_date'); ?></label>
    <div class="col-sm-12 col-lg-9">
...
<!--contract_end_date-->
<div class="form-group row">
    <label class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label"><?php echo app('translator')->get('lang.end_date'); ?></label>
    <div class="col-sm-12 col-lg-9">
...
<!--doc_value-->
<div class="form-group row">
    <label class="col-sm-12 col-lg-3 <?php echo e(app()->getLocale() == 'persian_br' ? 'text-right' : 'text-left'); ?> control-label col-form-label"><?php echo app('translator')->get('lang.value'); ?></label>
    <div class="col-sm-12 col-lg-9">
...
</div><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/contracts/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>